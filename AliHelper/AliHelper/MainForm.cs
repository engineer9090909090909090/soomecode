...
namespace AliHelper
{
    public partial class MainForm : Form
    {
        ...
        public static string proudctListRequest = "http://hz.productposting.alibaba.com/product/managementproducts/asyQueryProductList.do?status=approved&imageType=all&repositoryType=all&page={1}&size=50&changePageSize=Y&_csrf_token_={2}";
