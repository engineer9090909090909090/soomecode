    ...
    class Passporter
    {
        ...
        { 
            ...
            if (browser.Url.ToString() == loginUrl)
            {
                ...
                string url = GetLoginUrl(this.UserName, this.Password, dmtrackPageid, st);
            }
        }
        ...
        public string GetToken(string userId, string password, string dmtrackPageid)
        {
            ...
            string html = HtmlUtils.getContent(url);
        ...
        public string GetLoginUrl(string userId, string password, string dmtrackPageid, string st)
        {
